...
let AppGridComponent = class AppGridComponent {
    constructor(route, apiSvc) {
        this.route = route;
        this.apiSvc = apiSvc;
...
AppGridComponent.ctorParameters = () => [
...
let AppViewComponent = class AppViewComponent {
    constructor(route, locaton) {
        this.route = route;
...
AppViewComponent.ctorParameters = () => [
